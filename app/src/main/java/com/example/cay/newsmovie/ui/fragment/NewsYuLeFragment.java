...
public class NewsYuLeFragment extends BaseFragment<FragmentNewsTopBinding> {
   ...
   //需加，不然滑动不流畅
    ...
    protected void loadData() {
        OkHttpUtils.get().url("http://v.juhe.cn/toutiao/index").addParams("type", "top").addParams("key", "f9141352fe34615b0806e9fd943f9dbd").build().execute(new StringCallback() {
            @Override
