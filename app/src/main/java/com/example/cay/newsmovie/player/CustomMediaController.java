...
public class CustomMediaController extends MediaController {
    ...
    private ImageButton speed01;//快进
    private ImageButton speed02;//后退
    ...
    private View.OnClickListener speed01Listener = new View.OnClickListener() {
        public void onClick(View v) {
            if (activity != null) {
                videoView.seekTo(videoView.getCurrentPosition()+ SPEED_DATA);
            }
        }
    };
    //后退
    private View.OnClickListener speed02Listener = new View.OnClickListener() {
        public void onClick(View v) {
            if (activity != null) {
                videoView.seekTo(videoView.getCurrentPosition()- SPEED_DATA);
              //  CustomMediaController.sho
            }
        }
    };
    ...
    protected View makeControllerView() {
        ...
        speed01 = (ImageButton) v.findViewById(R.id.speed_1);
        speed02 = (ImageButton) v.findViewById(R.id.speed_2);
        speed01.setOnClickListener(speed01Listener);
        speed02.setOnClickListener(speed02Listener);
